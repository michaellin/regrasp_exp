...
#        self.runtime = runtime
    ...
    def sendNum(self, inputNumpyArray):
        ...
        if inputNumpyArray.size == 3:
            txMsg = struct.pack('<BBB', inputNumpyArray[0],inputNumpyArray[1],inputNumpyArray[2])
            self.ser.write(txMsg)
        elif inputNumpyArray.size == 4:
            txMsg = struct.pack('<BBBB', inputNumpyArray[0],inputNumpyArray[1],inputNumpyArray[2],inputNumpyArray[3])
            self.ser.write(txMsg)
        elif inputNumpyArray.size == 2:
            txMsg = struct.pack('<BB', inputNumpyArray[0],inputNumpyArray[1])
            self.ser.write(txMsg)
        else:
            print("Wrong SendNum Cmd")
